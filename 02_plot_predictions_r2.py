...
with open(os.path.join('pkls_r2', 'main_text_ridge_predictions.pkl'), 'rb') as i:
...
out_f = os.path.join('prediction_plots_r2', 'main_text')
            ...
            for targ in all_res[case][pov].keys():
                for fam in pred_fams:
                    ...
                    if general_case == 'r2':
                        ...
                        basic_corrs = all_res[case][pov][targ][general_case]['{} {}'.format(fam, pov)]
        ...
        for pov in all_res[case].keys():
            for targ in all_res[case][pov].keys():
                for fam in pred_fams:
                    ...
                    ax.hlines(y=0., xmin=-.5, xmax=2.5, color='gray')
                    if general_case == 'r2':
                        pyplot.ylabel('Impact of individual predictor \nremoval on R squared', fontsize=20, fontweight='bold')
