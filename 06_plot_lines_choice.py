...
for general_case in ['abilities', 'improvements']:
    ...
    curr_out_f = os.path.join('prediction_plots_{}'.format(args.choice), 'lines')
    ...
    for pred_fam, corr in [('main_text',-.1), ('si', .1)]:
        ...
        with open(os.path.join('pkls', '{}_ridge_predictions_{}.pkl'.format(pred_fam, args.choice)), 'rb') as i:
