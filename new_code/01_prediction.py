...
### we do it twice: mean and top10
for act_type in ['mean', 'top10']:
    out = os.path.join('pkls', act_type)
    ...
    activity_f = 'aphasia_recovery_47-{}-activity-allregressors.tsv'.format(act_type)
    sub_check = list()
    ...
    with open(os.path.join(out, 'full_results.pkl'), 'wb') as o:
    ...
    with open(os.path.join(out, 'var-by-var_results.pkl'), 'wb') as o:
