...
raw_data['T2-T1'] = (raw_data['T2']-raw_data['T1'])/(1-raw_data['T1'])
raw_data['T3-T1'] = (raw_data['T3']-raw_data['T1'])/(1-raw_data['T1'])
raw_data['T3-T2'] = (raw_data['T3']-raw_data['T2'])/(1-raw_data['T2'])
raw_data['T3-T2'][numpy.isnan(raw_data['T3-T2'])] = 1
